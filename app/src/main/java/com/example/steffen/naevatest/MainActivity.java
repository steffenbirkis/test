...
public class MainActivity extends Activity {
    ...
    protected void onPause() {
        ...
        if (namespace != null && instance != null) {
            ...
            editor.putString(PREF_NAMESPACE, current.getNameSpace());
            editor.putString(PREF_INSTANCE, current.getInstance());
    ...
    private void buildUi() {
        ...
        namespace.setText(current.getNameSpace());
        ...
        work.setText(current.getWorkplace());

        phone=(TextView) findViewById(R.id.phone);
        phone.setText(current.getPhoneNr());
    ...
    private void startAdvertising() {
        ...
        setEnabledViews(false, namespace, instance, txPower, txMode,name,work,phone);
    ...
    private void stopAdvertising() {
        ...
        setEnabledViews(true, namespace, instance, txPower, txMode);
    }
